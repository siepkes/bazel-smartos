...
Create a SmartOS container (joyent brand if you are on Triton). To build and use Bazel you need an image which has GCC 13. This guide assumes you use image `8adac45a-aca7-11ee-b53e-00151714048c` (23.4.0) with GCC 13. Be sure to fully update your container (`pkgin -y upgrade`).
...
# cd bazel-smartos
# git switch -c smartos-6.3.2-gcc13 origin/smartos-6.3.2-gcc13
# git format-patch -1
# cd ../bazel-6.3.2
