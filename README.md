...
Download [bazel-6.0.0-dist.zip](https://github.com/bazelbuild/bazel/releases/download/6.0.0/bazel-6.0.0-dist.zip) (the Bazel distribution) from the [Bazel releases](https://github.com/bazelbuild/bazel/releases) page.

Next we will prepare our source tree by putting everything together:

```
# mkdir bazel-6.0.0
# unzip bazel-6.0.0-dist.zip -d bazel-6.0.0
# git clone https://github.com/siepkes/bazel-smartos.git
# cd bazel-smartos
# git checkout smartos-6.0.0
# git format-patch -1
# cd ../bazel-6.0.0
# patch -p1 < ../bazel-smartos/0001-Modifications-to-port-Bazel-6.0.0-to-Illumos-SmartOS.patch
```
