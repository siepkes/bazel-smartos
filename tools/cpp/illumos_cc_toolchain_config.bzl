...
def _impl(ctx):
    ...
    if (is_illumos):
        ...
        cxx_builtin_include_directories = [
            ...
            "/opt/local/gcc13/include/c++/13.2.0/x86_64-sun-solaris2.11",
            "/opt/local/gcc13/include/c++/13.2.0/backward",
            "/opt/local/gcc13/lib/gcc/x86_64-sun-solaris2.11/13.2.0/include",
            "/opt/local/include",
            "/opt/local/gcc13/include",
            "/opt/local/gcc13/lib/gcc/x86_64-sun-solaris2.11/13.2.0/include-fixed",
            "/usr/include"
        ]
    else:
        cxx_builtin_include_directories = []
